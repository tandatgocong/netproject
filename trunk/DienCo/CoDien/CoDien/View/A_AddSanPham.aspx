<%@ Page Title="" Language="C#" MasterPageFile="~/View/Admin.Master" AutoEventWireup="true" CodeBehind="A_AddSanPham.aspx.cs" Inherits="CoDien.View.A_AddSanPham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <script language="javascript" type="text/javascript">
    ...
    <div style="margin-top:0px;" >
		<div class="title_page" style="font-size:16px; width:99%">
            <asp:Label ID="title" runat="server" Text="THÊM MỚI SẢN PHẨM"></asp:Label>
        </div>
