<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="MapGoogle.Login" %>
    ...
    <table border="0"  style="width:30%; border-bottom: #ff0033 thick double;">
        ...
        <tr>
            <td colspan="2" style="height: 35px">
                <asp:Button ID="Button1" runat="server"  Text="Đăng Nhập" Width="80px" 
                    onclick="Button1_Click" />
                <input id="Reset1" style="width: 80px" type="reset" value="Hủy bỏ" /><br />
                <br />
